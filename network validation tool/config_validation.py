""" Configurarion files validation

    This module is responsible for the format validation 
    of the device configuration files. The configuration files follow the 
    netplan config version 2 format.

    This file is called during device configruation
...
def print_error_msg(filename: str, error_msg: str) -> None:
    """ Prints an error message and exits, terminating the device configuration"""
